...
public class MultiHashmap<K, V> implements Multimap<K, V> {
    ...
    /** The map containing keys and collection of values */
    ...
    /**
     * Creates and initializes a new MultiHashmap with the keys and values
     ...
     * @param <V>
     *            The value type.
     * @return An new MultiHashmap initialized with multiMap.
     */
    public static <K, V> MultiHashmap<K, V> create(Multimap<K, V> multiMap) {
        MultiHashmap<K, V> ht = new MultiHashmap<K, V>();
        ht.merge(multiMap);
