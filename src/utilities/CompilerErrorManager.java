...
public enum CompilerErrorManager {
    ...
    private CompilerMessage d_postPonedMessage = null;
    
    /* List of errors/warning messages */
    private Stack<CompilerMessage> d_stackTrace;
    ...
    CompilerErrorManager() {
        d_errorCount = 0;
        d_stackTrace = new Stack<CompilerMessage>();
    }
    
    public void addMessageAndExit(CompilerMessage cm, MessageNumber msg) {
    ...
    public void reportMessageAndExit(CompilerMessage cm, MessageType mt) {
    ...
    public Stack<CompilerMessage> trace() {
        return d_stackTrace;
    }
    
    public CompilerMessage postPonedMessage() {
    ...
    public void printTrace(String src) {
        ...
        Iterator<CompilerMessage> it = d_stackTrace.iterator();
        while (it.hasNext()) {
    ...
    public void writeErrorToFile(String outputFile) {
        ...
        for (CompilerMessage cm : d_stackTrace)
