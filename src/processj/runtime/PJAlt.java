...
public class PJAlt {
    /**
     * An array of guard objects. A guard is either a skip, a channel read or a
     * timeout.
     */
    ...
    /**
     * Sets the guards and the Boolean pre-guards and returns true if one or more of
     * the Boolean pre-guards is true -- false otherwise.
     *
     * @param bg
     *            An array of Boolean values representing the values of the Boolean
     *            pre-guards.
     * @param guards
     *            An array of guards.
    ...
    /**
     * Returns the index (of guards[]) of the first guard that is ready. If no guard
     * is ready, -1 is returned.
     *
