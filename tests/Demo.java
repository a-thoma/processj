...
public class Demo {
    ...
    public static class _proc$main$arT extends PJProcess {
        ...
        public synchronized void run() {
            ...
            _ld$a3 = 2;
            _ld$b14 = new PJBarrier();
            _ld$b25 = new PJBarrier();
            final PJPar _ld$par1 = new PJPar(4, this);

            (new Demo._proc$writer$cwLL$R(_ld$c1, _ld$b14) {
                @Override
            ...
            (new Demo._proc$reader$crLL$R(_ld$c1, _ld$b14) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
            ...
            (new Demo._proc$writeXX$cwLXX$R(_ld$x2, _ld$b25) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
            ...
            (new Demo._proc$readXX$crLXX$R(_ld$x2, _ld$b25) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
