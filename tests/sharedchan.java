 ...
 * Package name 'tests'.
 * Code generation for 'sharedchan.pj'.
 * Target class 'sharedchan'.
...
public class sharedchan {
    ...
    public static class _proc$reader$I$crI extends PJProcess {
        ...
        public _proc$reader$I$crI(int _pd$id1, PJChannel<Integer> _pd$in2) {
    ...
    public static class _proc$writer$cwI extends PJProcess {
        ...
        public _proc$writer$cwI(PJChannel<Integer> _pd$out1) {
    ...
    public static class _proc$main$arT extends PJProcess {
        ...
        public synchronized void run() {
            ...
            _ld$c1 = new PJMany2ManyChannel<Integer>();
            _ld$a2 = 129;
            final PJPar _ld$par1 = new PJPar(5, this);

            (new sharedchan._proc$reader$I$crI(1, _ld$c1) {
                @Override
            ...
            (new sharedchan._proc$reader$I$crI(2, _ld$c1) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
            ...
            (new sharedchan._proc$reader$I$crI(3, _ld$c1) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
            ...
            (new sharedchan._proc$writer$cwI(_ld$c1) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
    ...
    public static void main(String[] _pd$args1) {
        ...
        (new sharedchan._proc$main$arT(_pd$args1)).schedule();
