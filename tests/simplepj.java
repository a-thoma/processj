 ...
 * Package name 'tests'.
 * Code generation for 'simplepj.pj'.
 * Target class 'simplepj'.
...
public class simplepj {
    ...
    public static class _proc$main$arT extends PJProcess {
        ...
        public synchronized void run() {
            ...
            (new simplepj._proc$foo$cwI(_ld$c1) {
                @Override
            ...
            (new simplepj._proc$bar$crI(_ld$c1) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
    ...
    public static void main(String[] _pd$args1) {
        ...
        (new simplepj._proc$main$arT(_pd$args1)).schedule();
