...
public class readEx {
    ...
    public static class _proc$bar$cwI extends PJProcess {
        protected PJChannel<Integer> _pd$w1;

        protected int _ld$a1;

        public _proc$bar$cwI(PJChannel<Integer> _pd$w1) {
            this._pd$w1 = _pd$w1;
        }
    ...
    public static class _proc$main$arT extends PJProcess {
        ...
        public synchronized void run() {
            ...
            (new readEx._proc$foo$crI(_ld$c1) {
                @Override
            ...
            (new readEx._proc$bar$cwI(_ld$c1) {
                @Override
                public void finalize() {
                    _ld$par1.decrement();
                }
    ...
    public static void main(String[] _pd$args1) {
        ...
        (new readEx._proc$main$arT(_pd$args1)).schedule();
